...
let initWebRoutes = (app) => {
    ...
    router.get('/detail/product/:id', homeController.getDetailPage)
    router.post('/create-new-product', homeController.createNewProduct)
    router.post('/delete-product', homeController.deleteProduct)
    router.get('/edit-product/:id', homeController.getEditPage)
    router.post('/update-product', homeController.postUpdateProduct)
