...
import useFetch from "../Asses/js/fetch"
import "../Asses/css/product.scss"


export const Product = () => {
  let {id} = useParams()
  const [value,setValue] = useState(1)
  const data = useFetch(`http://localhost:8080/api/product/${id}`)
  ...
  return (
    <div className="container">
      <div className="breadcrumb">
        <Link to="/" className="link">Shopee</Link>
        <i className="icon fas fa-chevron-right"></i>
        <p className="text">Computer &amp; Accessories</p>
        <i className="icon fas fa-chevron-right"></i>
        <p className="text2">Monitors</p>
        <i className="icon fas fa-chevron-right"></i>
        <p className="text3">{data.name}</p>
      </div>
                        ...
                        <div id="carouselExampleIndicators" className="carousel slide"  data-bs-interval="false">
                          ...
                          <div className="switch-img">
                            <div className="carousel-indicators">
                              <div className="btn active" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1">
                                <img src={data.image} alt="" />
                              </div>
                              <div className="btn" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                <img src={data.image} alt="" />
                              </div>
                              <div className="btn" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                <img src={data.image} alt="" />
                              </div>
                              <div className="btn" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4">
                                <img src={data.image} alt="" />
                              </div>
                              <div className="btn" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="4" aria-label="Slide 5">
                              <img src={data.image} alt="" />
                              </div>
                    ...
                    <div className="want">
                      <div className="first">
                        <div className="shares">
                          ...
                          <div className="icons">
                            <i className="icon a fab fa-facebook"></i>
                            <i className="icon b fab fa-facebook-messenger"></i>
                            <i className="icon c fab fa-pinterest"></i>
                            <i className="icon d fab fa-twitter"></i>
                          </div>
                        </div>
                      </div>
                      <div className="second">
                        <i className="far fa-heart"></i>
                        <span className="text">Đã thích (35)</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-7">
                  <div className="parameter">
                    <div className="header">
                      <h4 className="title-text"><span className="title">Mall</span> {data.description} </h4>
                    </div>
                    <div className="depen">
                    ...
                    <div className="ins">
                      <div className="more">
                        <div className="installment">
                          <div className="first">0% TRẢ GÓP</div>
                          <div className="second">12 tháng x ₫504.167 (Lãi suất 0%)</div>
                        ...
                        <div className="transport">
                          <div className="first">Vận Chuyển</div>
                          <div className="nown">
                            <div className="second">
                              <div className="car">
                                <i className="fas fa-truck"></i>
                                <span className="text">Vận Chuyển Tới</span>
                              </div>
                              <div className="place">
                                <div className="text">Ba vì</div>
                                <i className="fas fa-chevron-down"></i>                              
                              </div>
                            </div>
                            <div className="last">
                              <div className="cost">Phí Vận Chuyển</div>
                              <div className="ship">
                                <div className="text">đ45.000</div>
                        ...
                        <div className="quantity">
                          <div className="first">Số Lượng</div>
                          <div className="second">
                            <div className="spinner">
                              <button className="prev" onClick={subTract}>-</button>
                              <input className="number-spinner" type="text" value={value} onChange={()=>{}}/>
                              <button className="next" onClick={add}>+</button>
                            </div>
                          </div>
                          <div className="last">10 sản phẩm có sẵn</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="ques">
                      <div className="another">
                        <div className="first">
                          <img className="image" src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/6c502a2641457578b0d5f5153b53dd5d.png" alt="" />
                          <span className="text">7 ngày miễn phí trả hàng</span>
                        </div>
                        <div className="second">
                          <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/16ead7e0a68c3cff9f32910e4be08122.png" alt="" className="image" />
                          <span className="text">Hàng chính hãng 100%</span>
                        </div>
                        <div className="last">
                          <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/511aca04cc3ba9234ab0e4fcf20768a2.png" alt="" className="image" />
                          <span className="text">Miễn phí vận chuyển</span>
                        </div>
                      </div>
                    </div>
                  </div>
